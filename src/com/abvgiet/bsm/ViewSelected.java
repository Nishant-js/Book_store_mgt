...
public class ViewSelected extends JFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static ViewSelected frame;
	...
	public ViewSelected() {
		...
		JButton btnViewSelected = new JButton("Delete Book");
		...
		JButton btnLoadRecord = new JButton("Load Details");
		btnLoadRecord.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(sBook_id==null||sBook_id.trim().equals("")){
					JOptionPane.showMessageDialog(ViewSelected.this,"Please enter Book_id first!");
				}else{
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(128)
					.addComponent(btnViewSelected, GroupLayout.PREFERRED_SIZE, 145, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(7)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(btnViewSelected, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnBack))
					.addContainerGap())
		);
