...
public class UpdateBook extends JFrame {
	...
	public UpdateBook() {
		...
		JButton btnUpdateBook = new JButton("Update Student");
		btnUpdateBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                if(status>0){
					...
					JOptionPane.showMessageDialog(UpdateBook.this,"Sorry, Unable to add Book!");
				}
		...
		btnLoadRecord.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(sBook_id==null||sBook_id.trim().equals("")){
					JOptionPane.showMessageDialog(UpdateBook.this,"Please enter Book_id first!");
				}else{
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(128)
					.addComponent(btnUpdateBook, GroupLayout.PREFERRED_SIZE, 145, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(7)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(btnUpdateBook, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnBack))
					.addContainerGap())
		);
